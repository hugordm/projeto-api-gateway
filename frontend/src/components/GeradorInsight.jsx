    ...
    <div className="w-full mt-8 flex flex-col items-center gap-6">
      ...
      {status === 'loading' && (
        <div className="flex flex-col items-center gap-4 text-slate-400">
          ...
          <p className="animate-pulse">Analisando histórico e tendências...</p>
        </div>
      )}
      ...
      {(status === 'typing' || status === 'done') && (
        ...
        >
          ...
          <h3 className="text-[#c8b7e9] font-bold mb-4 flex items-center gap-2">
            <Sparkles size={20} /> Análise Inteligente
          </h3>
